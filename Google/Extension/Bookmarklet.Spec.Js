...
const url = 'https://www.dropbox.com/s/uh32s8hiuj4bdz4/apfBookmarklet.js?dl=0';
...
const url = 'https://raw.githubusercontent.com/user/project/branch/apfBookmarklet.js';
...
const url = 'https://raw.githubusercontent.com/user/project/branch/filter.js';
...
it('should translate url', function() {
const url = 'https://gist.githubusercontent.com/user/gist_id/raw/revision_id/apfBookmarklet.js';
...
const url = 'https://gist.githubusercontent.com/user/gist_id/raw/revision_id/filter.js';
...
const url = 'https://gist.github.com/user/gist_id';
...
it('should translate url', function() {
const url = 'https://drive.google.com/file/e/17I2zgcq8Qpt4VVdYiVk/view?usp=sharing';
